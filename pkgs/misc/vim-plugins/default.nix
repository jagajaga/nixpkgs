...
rec {
  ...
  vim-addon-vim2nix = buildVimPluginFrom2Nix { # created by nix#NixDerivation
    ...
    src = fetchgit {
      ...
      rev = "8bb2ab4b290d5ef16f33b98f6e7748df17885363";
      sha256 = "f9d3bb3ed67ff183a2091ece4f2b45564431c20c566d22430dd2d2a7bf66b649";
    };
  ...
  a.vim.git = buildVimPluginFrom2Nix { # created by nix#NixDerivation
  ...
  align.git = buildVimPluginFrom2Nix { # created by nix#NixDerivation
